...
<p class="tc-sub">TacCap-Gripper handheld tactile gripper × Pico4 Ultra tracker — a full imitation-learning data collection on lerobot, straight to a standard <code>LeRobotDataset</code>.</p>
